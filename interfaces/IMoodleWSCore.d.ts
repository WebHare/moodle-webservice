...
export default interface IMoodleWSCore {
    ...
    auth: {
        ...
        isAgeDigitalConsentVerificationEnabled: (params: IMoodleWSParams) => Promise<any>;
    ...
    completion: {
        ...
        updateActivityCompletionStatusManually: (params: IMoodleWSParams) => Promise<any>;
    };
    contentbank: {
